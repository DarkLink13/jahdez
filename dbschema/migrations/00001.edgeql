CREATE MIGRATION m172o2vchxyth6jvm36b7x3gevwhhvdc2vvnzgueju7lmgr5wfvmca
    ONTO initial
{
  ...
  CREATE SCALAR TYPE default::LabelType EXTENDING enum<Date, Years, Since, Version, Link, Current, WorkType, Role>;
  ...
  CREATE SCALAR TYPE default::ModeType EXTENDING enum<dark, light>;

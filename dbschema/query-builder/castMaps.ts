...
export type scalarAssignableBy<T extends $.ScalarType> =
  ...
  T extends _default.$ModeType ? _default.$ModeType : 
  T extends _default.$LabelType ? _default.$LabelType : 
  T extends _default.$ItemType ? _default.$ItemType : 
...
type getSharedParentScalar<A, B> =
  ...
  A extends _auth.$FlowType ?
    ...
    never
  :
  A extends _default.$ModeType ?
    B extends _default.$ModeType ?
    B
    :
    never
  :
  A extends _default.$LabelType ?
    B extends _default.$LabelType ?
    B
    :
    never
  :
  A extends _default.$ItemType ?
    B extends _default.$ItemType ?
    B
    :
    never
  :
...
function getSharedParentScalar<A extends $.ScalarType, B extends $.ScalarType>(a: A, b: B): A | B {
  ...
  if (a.__name__ === "default::ModeType") {
    if(b.__name__ === "default::ModeType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::LabelType") {
    if(b.__name__ === "default::LabelType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::ItemType") {
    if(b.__name__ === "default::ItemType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
